...
if (temperature > 80 && raining){
  console.log("It's raining out, but you can still wear a t-shirt")
} else if (temperature > 60 && raining){
  console.log("Wear a jacket, it's raining outside")
} else if (temperature < 80 && raining){
  console.log("It's warm and raining outside")
} else if (temperature < 60 && raining){
  console.log("It's cold and raining outside, wear a coat")
} else {
  console.log('It will be cold out today')
}
